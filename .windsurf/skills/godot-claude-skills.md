...
Develop, test, build, and deploy Godot 4.x games with AI assistance.

**Source:** https://github.com/Randroids-Dojo/Godot-Claude-Skills
...
```bash
/plugin marketplace add Randroids-Dojo/Godot-AI-Skills
...
```bash
git clone https://github.com/Randroids-Dojo/Godot-AI-Skills.git
mkdir -p your-project/.claude/skills
cp -r Godot-AI-Skills/skills/godot your-project/.claude/skills/
```
...
cp -r Godot-AI-Skills/skills/godot ~/.claude/skills/
```
