...
func _ready() -> void:
	...
	_init_key_map()
	# Read port from project settings if configured
	if ProjectSettings.has_setting("application/config/mcp_server_port"):
		PORT = int(ProjectSettings.get_setting("application/config/mcp_server_port"))
