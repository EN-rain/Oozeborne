...
const NakamaLoggerScript = preload("res://addons/com.heroiclabs.nakama/utils/NakamaLogger.gd")
...
const DEFAULT_LOG_LEVEL = NakamaLoggerScript.LOG_LEVEL.DEBUG

var _http_adapter = null
var logger = NakamaLoggerScript.new()
